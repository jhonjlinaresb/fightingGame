...
class Personaje {
  ...
  const pers2 = new Personaje("Ban", 12, 5, 15);
  const pers3 = new Personaje("Merlin", 60, 0, 35);
  const pers4 = new Personaje("Diane", 80, 5, 20);
  const pers5 = new Personaje("Escanor", 100, 5, 15);
  const pers6 = new Personaje("King", 100, 10, 15);
  const pers7 = new Personaje("Gowther", 100, 5, 15);
  const pers8 = new Personaje("Hawk", 150, 5, 7);
  
  //Se almacenan en un array para recorrerlos y pintarlos
  let arrayPJ = [pers1, pers2, pers3, pers4, pers5, pers6, pers7, pers8];
